            ...
            <div className="col-md-4">
              ...
              <div className="tab-head">
                ...
                <div id="accordion" className="accordion tabArea">
                  ...
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/services/training/site" className="collapsed">
                  ...
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/services/netsubscription" className="collapsed">
                        Tally.Net Services
                      </a>
                    </h6>
                  </div>
                  ...
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/services/supportcover" className="collapsed">
                        {' '}
                  ...
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/download/instantsupport" className="collapsed">
              ...
              <div className="tab-head">
                ...
                <div id="accordion" className="accordion tabArea">
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/solutions/addonmodules" className="collapsed">
                  ...
                  <div className="card-header1">
                    <h6 className="mb-0">
                      <Link="/company/clientage" className="collapsed">
